  ...
  useEffect(() => {
    const listaProductos = new Promise((res, rej) => {
      setTimeout(() => {
        ...
        (idCategoria == undefined)?res(productos):res(productos.filter((producto) => producto.categoria == idCategoria))
      }, 2000)
    });
